#
# Be sure to run `pod lib lint KahunaControlAppBootup.podspec' to ensure this is a
...
KahunaControlAppBootup library to detect an app to boot or not based on that apply app version, os version and  free space in a device.
  ...
  s.source           = { :git => 'https://github.com/siddharthchopra/KahunaControlAppBootup.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'KahunaControlAppBootup/Classes/**/*'
  
  # s.resource_bundles = {
  #   'KahunaControlAppBootup' => ['KahunaControlAppBootup/Assets/*.png']
  # }
